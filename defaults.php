...
class OC_Theme {
	...
	public function getBaseUrl() {
		return 'https://www.eigener-server.ch/en/igel-cloud';
	}
	...
	public function getEntity() {
		return 'Nextcloud powerd by Hedgehog Cloud';
	}
	...
	public function getSlogan() {
		return 'Your custom cloud, set-up easy and fast!';
	}
	...
	public function getShortFooter() {
		$footer = 'CC BY <a href="'.$this->getBaseUrl().'" target="_blank\">'.$this->getEntity().'</a>'.
			'<br/>' . $this->getSlogan();
